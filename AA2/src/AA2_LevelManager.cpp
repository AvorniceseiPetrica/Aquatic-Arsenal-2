...
{
    levels[0] = new AA2_Level("Assets/Maps/map0.txt", "Assets/Backgrounds/background.png", "Assets/Backgrounds/midground.png", {.x = 200, .y = 1200});
    levels[1] = new AA2_Level("Assets/Maps/map1.txt", "Assets/Backgrounds/background.png","Assets/Backgrounds/midground.png", {.x = 200, .y = 800});
